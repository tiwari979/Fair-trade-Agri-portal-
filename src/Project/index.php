        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
          ...
          <div class="w-full">
            <div class="w-full h-80 sm:h-[28rem] md:h-[30rem] lg:h-[34rem] rounded-xl overflow-hidden shadow-lg">
              <iframe class="w-full h-full rounded-lg" src="https://www.bing.com/videos/riverview/relatedvideo?&q=farmer&&mid=80CCABBCE989360943DB80CCABBCE989360943DB&&mcid=F4004F1135B94C77B188757E4060CD27&FORM=GVRPTV?autoplay=1&mute=1"
